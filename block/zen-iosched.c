...
static const int sync_expire  = HZ / 300;    /* max time before a sync is submitted. */
static const int async_expire = 2500 * HZ;    /* ditto for async, these limits are SOFT! */
static const int fifo_batch = 0;
