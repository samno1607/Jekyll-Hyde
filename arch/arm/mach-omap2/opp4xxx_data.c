 ...
 */
#define OMAP4430_VDD_MPU_OPP10_UV		850000
#define OMAP4430_VDD_MPU_OPP25_UV		900000
#define OMAP4430_VDD_MPU_OPP50_UV		925000
#define OMAP4430_VDD_MPU_OPP75_UV		1000000
#define OMAP4430_VDD_MPU_OPP100_UV		1025000
#define OMAP4430_VDD_MPU_OPP125_UV		1075000
#define OMAP4430_VDD_MPU_OPP150_UV		1100000
#define OMAP4430_VDD_MPU_OPPTURBO_UV		1175000
#define OMAP4430_VDD_MPU_OPPTURBO2_UV		1200000
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP10_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0x00, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP25_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0x00, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0x00, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP75_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0x00, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0x00, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP125_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0x00, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPTURBO2_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0x00, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0x00, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO2_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0x00, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0x01, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB2_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0x01, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB3_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0x01, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB4_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0x01, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB5_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0x01, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
struct omap_volt_data omap443x_vdd_iva_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_IVA_OPPNITRO_UV, 0, OMAP44XX_CONTROL_FUSE_IVA_OPPNITRO, 0x01, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_IVA_OPPNITROSB_UV, 0, OMAP44XX_CONTROL_FUSE_IVA_OPPNITROSB, 0x01, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0),
};
...
static struct omap_vdd_dep_volt omap443x_vdd_mpu_core_dep_data[] = {
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPP10_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP50_UV},
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPP75_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP50_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPP100_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPP125_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	...
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPTURBO2_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = {
	...
	/* MPU OPP-1200 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1228800000, OMAP4430_VDD_MPU_OPPNITROSB_UV),
	/* MPU OPP-1300 - OPP-SB2 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1305600000, OMAP4430_VDD_MPU_OPPNITROSB2_UV),
	/* MPU OPP-1400 - OPP-SB3 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1420800000, OMAP4430_VDD_MPU_OPPNITROSB3_UV),
	/* MPU OPP-1500 - OPP-SB4 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1536000000, OMAP4430_VDD_MPU_OPPNITROSB4_UV),
	/* MPU OPP-1600 - OPP-SB5 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", false, 1612800000, OMAP4430_VDD_MPU_OPPNITROSB5_UV),
	/* L3 OPP1 - OPP50 */
	OPP_INITIALIZER("l3_main_1", "virt_l3_ck", "core", true, 133000000, OMAP4430_VDD_CORE_OPP50_UV),
	/* L3 OPP2 - OPP100 */
	OPP_INITIALIZER("l3_main_1", "virt_l3_ck", "core", true, 266000000, OMAP4430_VDD_CORE_OPP100_UV),
	/* L3 OPP3 - OPP-Turbo */
//	OPP_INITIALIZER("l3_main_1", "virt_l3_ck", "core", false, 266000000, OMAP4430_VDD_CORE_OPP100_OV_UV),
	/* IVA OPP4 - OPP-Nitro */
//	OPP_INITIALIZER("l3_main_1", "virt_l3_ck", "core", false, 365000000, OMAP4430_VDD_CORE_OPP100_OV_UV),
	/* IVA OPP5 - OPP-NitroSB */
//	OPP_INITIALIZER("l3_main_1", "virt_l3_ck", "core", false, 399000000, OMAP4430_VDD_CORE_OPP100_OV_UV),
	/* IVA OPP1 - OPP50 */
...
struct omap_volt_data omap446x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP50_UV, 38000, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0x00, 0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0x00, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OV_UV, 13000, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0x00, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0),
};
...
int __init omap4_opp_init(void)
{
	...
	if (omap4_has_mpu_1_2ghz())
		omap4_opp_enable("mpu", 1113600000);
